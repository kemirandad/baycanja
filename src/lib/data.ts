...
export const participants: Participant[] = [
  // Canto - Categoría A
  {
    ...
    photoUrl: '/images/participants/juan-jose-parejo-jimenez.png?v=8',
    category: 'A',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/jariana-sofia-apresa-arrollo.png?v=8',
    category: 'A',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/jaime-andres-villarete-galeano.png?v=8',
    category: 'A',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/samuel-david-nisperuza-caicedo.png?v=8',
    category: 'A',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/ana-castilla.png?v=8',
    category: 'A',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/ana-lucia-ruiz-garcia.png?v=8',
    category: 'A',
    eventType: 'Canto',
  },
  // Canto - Categoría B
  {
    ...
    photoUrl: '/images/participants/adriana-yisel-contreras-reino.png?v=8',
    category: 'B',
    eventType: 'Canto',
  },
  {
  ...
  },
  {
    ...
    photoUrl: '/images/participants/samuel-logreira-martinez.png?v=8',
    category: 'B',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/valeria-carolina-meza-charris.png?v=8',
    category: 'B',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/vanessa-arango.png?v=8',
    category: 'B',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/dallana-andrea-pineda-perez.png?v=8',
    category: 'B',
    eventType: 'Canto',
  },
  // Baile - Categoría A
  ...
  },
  {
    ...
    photoUrl: '/images/participants/grupo-pequenos-con-ritmo.png?v=8',
    category: 'A',
    eventType: 'Baile',
  },
  {
    ...
    photoUrl: '/images/participants/danza-de-los-pajaros.png?v=8',
    category: 'A',
    eventType: 'Baile',
  },
    // Baile - Categoría B
  {
    ...
    photoUrl: '/images/participants/grupo-folclorico-san-francisco-javier.png?v=8',
    category: 'B',
    eventType: 'Baile',
  },
  {
    ...
    photoUrl: '/images/participants/grupo-the-flow.png?v=8',
    category: 'B',
eventType: 'Baile',
  },
  {
    ...
    photoUrl: '/images/participants/danza-paloteo.png?v=8',
    category: 'B',
    eventType: 'Baile',
  },
  {
    ...
    photoUrl: '/images/participants/grupo-reyvolution.png?v=8',
    category: 'B',
    eventType: 'Baile',
  },
  {
    ...
    photoUrl: '/images/participants/grupo-folclorico-de-danza.png?v=8',
    category: 'B',
    eventType: 'Baile',
  },
];
