...
export const participants: Participant[] = [
  ...
  },
  {
    ...
    photoUrl: '/images/participants/jariana-sofia-apresa-arrollo.png?v=9',
    category: 'A',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/jaime-andres-villarete-galeano.png?v=9',
    category: 'A',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/samuel-david-nisperuza-caicedo.png?v=9',
    category: 'A',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/ana-castilla.png?v=9',
    category: 'A',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/ana-lucia-ruiz-garcia.png?v=9',
    category: 'A',
    eventType: 'Canto',
  },
  // Canto - Categoría B
  {
    ...
    photoUrl: '/images/participants/adriana-yisel-contreras-reino.png?v=9',
    category: 'B',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/mariangel-victoria-chourio-peña.png?v=9',
    category: 'B',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/samuel-logreira-martinez.png?v=9',
    category: 'B',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/valeria-carolina-meza-charris.png?v=9',
    category: 'B',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/vanessa-arango.png?v=9',
    category: 'B',
    eventType: 'Canto',
  },
  {
    ...
    photoUrl: '/images/participants/dallana-andrea-pineda-perez.png?v=9',
    category: 'B',
    eventType: 'Canto',
  },
  // Baile - Categoría A
  {
    ...
    photoUrl: '/images/participants/grupo-body-and-soul.png?v=9',
    category: 'A',
    eventType: 'Baile',
  },
  {
    ...
    photoUrl: '/images/participants/grupo-pequenos-con-ritmo.png?v=9',
    category: 'A',
    eventType: 'Baile',
  },
  {
    ...
    photoUrl: '/images/participants/danza-de-los-pajaros.png?v=9',
    category: 'A',
    eventType: 'Baile',
  },
    // Baile - Categoría B
  {
    ...
    photoUrl: '/images/participants/grupo-folclorico-san-francisco-javier.png?v=9',
    category: 'B',
    eventType: 'Baile',
  },
  {
  ...
  },
  {
    ...
    photoUrl: '/images/participants/danza-paloteo.png?v=9',
    category: 'B',
    eventType: 'Baile',
  },
  {
    ...
    photoUrl: '/images/participants/grupo-reyvolution.png?v=9',
    category: 'B',
    eventType: 'Baile',
  },
  {
    ...
    photoUrl: '/images/participants/grupo-folclorico-de-danza.png?v=9',
    category: 'B',
    eventType: 'Baile',
  },
];
